...
public class QCommunity extends EntityPathBase<Community> {
    ...
    public final ListPath<study.EndGame.comment.CommentEntity, study.EndGame.comment.QCommentEntity> commentEntityList = this.<study.EndGame.comment.CommentEntity, study.EndGame.comment.QCommentEntity>createList("commentEntityList", study.EndGame.comment.CommentEntity.class, study.EndGame.comment.QCommentEntity.class, PathInits.DIRECT2);
    ...
    public final ListPath<study.EndGame.file.FileEntity, study.EndGame.file.QFileEntity> fileEntityList = this.<study.EndGame.file.FileEntity, study.EndGame.file.QFileEntity>createList("fileEntityList", study.EndGame.file.FileEntity.class, study.EndGame.file.QFileEntity.class, PathInits.DIRECT2);
