...
import study.EndGame.file.FileEntity;
import study.EndGame.file.FileRepository;
...
public class CommunityService {
    ...
    public void save(CommunityDto communityDto) throws IOException {
        ...
        if (communityDto.getCommunityFile().isEmpty()) {
            ...
            String savePath = "D:/endcar2(se)/src/main/resources/static/img/" + storedFileName; // 4.
