package ENDGAME.ENDCAR.config;

import ENDGAME.ENDCAR.constant.UserRole;
import ENDGAME.ENDCAR.dto.auth.MyAccessDeniedHandler;
import ENDGAME.ENDCAR.dto.auth.MyAuthenticationEntryPoint;
import ENDGAME.ENDCAR.dto.auth.oauth.PrincipalOauth2UserService;
